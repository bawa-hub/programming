...
func showUsage() {
	fmt.Println("🔒 Go Sync Primitives - Complete Guide")
	fmt.Println("======================================")
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  go run sync_primitives.go <example_number>  # Run specific example (1-15)")
	fmt.Println("  go run sync_primitives.go basic             # Run basic primitives (1-6)")
	fmt.Println("  go run sync_primitives.go advanced          # Run advanced primitives (7-10)")
	fmt.Println("  go run sync_primitives.go patterns          # Run common patterns (11-15)")
	fmt.Println("  go run sync_primitives.go all               # Run all examples")
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  1  - Mutex - Basic Usage")
	fmt.Println("  2  - Mutex - Without Protection (Race Condition)")
	...
	fmt.Println("  7  - Atomic Operations")
	fmt.Println("  8  - Pool - Object Pooling")
	fmt.Println("  9  - Map - Concurrent Map")
	fmt.Println("  10 - Semaphore - Counting Semaphore")
	fmt.Println("  11 - Producer-Consumer Pattern")
	fmt.Println("  12 - Worker Pool Pattern")
	fmt.Println("  13 - Rate Limiting Pattern")
	fmt.Println("  14 - Circuit Breaker Pattern")
	fmt.Println("  15 - Graceful Shutdown Pattern")
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  go run sync_primitives.go 1    # Run example 1")
	fmt.Println("  go run sync_primitives.go 5    # Run example 5")
	fmt.Println("  go run sync_primitives.go basic # Run basic primitives")
	fmt.Println("  go run sync_primitives.go all  # Run all examples")
}
