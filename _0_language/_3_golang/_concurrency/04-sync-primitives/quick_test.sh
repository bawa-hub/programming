#!/bin/bash
# Quick Test Script for Synchronization Primitives

echo "🧪 Running Quick Synchronization Test Suite"
echo "==========================================="
...
# Test 5: Race detection (should detect intentional race for educational purposes)
echo "5. Testing race detection..."
if go run -race . basic 2>&1 | grep -q "WARNING: DATA RACE"; then
    echo "✅ Race detection: PASS (correctly detected intentional race)"
else
...
echo "==========================================="
echo "🎉 All tests passed! Synchronization topic is ready!"
echo "🚀 Ready to move to Worker Pool Pattern!"
