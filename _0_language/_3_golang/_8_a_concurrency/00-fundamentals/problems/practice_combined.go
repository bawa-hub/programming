...
func problem19() {
	...
	// Use unbuffered to avoid unused variable warning
	_ = unbuffered
}
...
func problem42() {
	...
	// Use ch to avoid unused variable warning
	_ = ch
}
...
func showUsage() {
	...
	fmt.Println()
	fmt.Println("Usage:")
	fmt.Println("  go run practice_combined.go <problem_number>  # Run specific problem (1-50)")
	fmt.Println("  go run practice_combined.go easy              # Run easy problems (1-15)")
	fmt.Println("  go run practice_combined.go medium            # Run medium problems (16-35)")
	fmt.Println("  go run practice_combined.go advanced          # Run advanced problems (36-50)")
	fmt.Println("  go run practice_combined.go all               # Run all problems")
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  go run practice_combined.go 1                 # Run problem 1")
	fmt.Println("  go run practice_combined.go 25                # Run problem 25")
	fmt.Println("  go run practice_combined.go easy              # Run all easy problems")
	fmt.Println("  go run practice_combined.go all               # Run all 50 problems")
	fmt.Println()
